...
" for Vim-Header
let g:header_field_author = 'Kent Zhang'
let g:header_field_author_email = 'tyzhang108@gmail.com'
map <leader>ah :AddHeader<CR>

" for vim licenses
let g:licenses_authors_name = 'Zhang, Kent <tyzhang108@gmail.com>'
let g:licenses_copyright_holders_name = 'Zhang, Kent <tyzhang108@gmail.com>'
