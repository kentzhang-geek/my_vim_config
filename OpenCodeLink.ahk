...
MyGui := Gui()
MyGui.Add("Text", "Section", "CodeLink:")
CLink := MyGui.Add("Edit", "w460 r1")
MyGui.Add("Text", "Section", "BC pattern:")
Replace_pattern := MyGui.Add("Edit", "w460 r1")
MyGui.Add("Text", "Section", "BC target:")
Replace_target := MyGui.Add("Edit", "w460 r1")
